...
impl Resolver {
    ...
    fn repo_for(&self, dep: &Dependency) -> Result<Option<RepoRef>> {
        ...
        if repo.is_none()
            && matches!(
                dep.ecosystem,
                Ecosystem::Brew | Ecosystem::Pacman | Ecosystem::Apt | Ecosystem::Dnf | Ecosystem::Nix
            )
        {
...
fn registry_url(dep: &Dependency) -> Option<String> {
    Some(match dep.ecosystem {
        ...
        Ecosystem::Go | Ecosystem::Pacman | Ecosystem::Apt | Ecosystem::Dnf | Ecosystem::Nix => return None,
    })
}
...
fn repo_candidates(eco: Ecosystem, v: &serde_json::Value) -> Vec<String> {
    ...
    match eco {
        ...
        Ecosystem::Go | Ecosystem::Pacman | Ecosystem::Apt | Ecosystem::Dnf | Ecosystem::Nix => Vec::new(),
    }
}
